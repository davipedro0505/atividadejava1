...
List<String> autores_bancada2 = Arrays.asList(
    "Dep. André de Paula",
    "Dep. André Ferreira",
...
List<String> convenio_bancada2 = Arrays.asList(
    "NENHUM REGISTRO ENCONTRADO"
);

List<String> documento_bancada2 = Arrays.asList(
    "Data: 11/4/2024 - Documento: 2024NE530061 - Fase: EMPENHO",
    "Data: 24/04/2024 - Documento: 2024NS001754 - Fase: LIQUIDAÇÃO",
    "Data: 10/05/2024 - Documento: 2024NE470184 - Fase: PAGAMENTO"
);
...
"PERNAMBUCO/PE", 0.00f, 0.00f, 9963183.00f, convenio_bancada1, documento_bancada3);
...
List<String> documento_relator1 = Arrays.asList(
