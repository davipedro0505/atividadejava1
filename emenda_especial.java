...
public emenda_especial(String codigo, List<String> autores, int ano_emenda, String area_atuacao, String localidade, float valor_liquidado, float valor_pago, float valor_empenho, List<String> convenio, List<String> documentos) {
this.codigo = codigo;
...
System.out.println("--- EMENDA ESPECIAL ---");
