...
public class emenda_individual {
...
public emenda_individual(String codigo, List<String> autores, int ano_emenda, String area_atuacao, String localidade, float valor_liquidado, float valor_pago, float valor_empenho, List<String> convenio, List<String> documentos) {
this.codigo = codigo;
